...
const ExternalLink = () => {
  return (
    ...
    <Box fontSize={'25px'} textAlign={'left'} height={'auto'} width={'600px'} word-wrap={'break-word'}>
        <Link color='#ff423d' href={'https://medlineplus.gov/ency/article/001214.htm'} isExternal>MedLinePlus{' '}<ExternalLinkIcon mx='2px'/></Link><br/><br/>
        <Link color='#ff423d' href={'https://www.who.int/news-room/fact-sheets/detail/diabetes'} isExternal>World Health Organization{' '}<ExternalLinkIcon mx='2px'/></Link><br/><br/>
